...
BattleMusic_Trainers:
	db WILL,             MUSIC_JOHTO_GYM_LEADER_BATTLE ; MUSIC_ELITE_FOUR_BATTLE_SM
	db KOGA,             MUSIC_JOHTO_GYM_LEADER_BATTLE ; MUSIC_ELITE_FOUR_BATTLE_SM
	db BRUNO,            MUSIC_JOHTO_GYM_LEADER_BATTLE ; MUSIC_ELITE_FOUR_BATTLE_SM
	db KAREN,            MUSIC_JOHTO_GYM_LEADER_BATTLE ; MUSIC_ELITE_FOUR_BATTLE_SM
	db CHAMPION,         MUSIC_CHAMPION_BATTLE
	db RED,              MUSIC_KANTO_CHAMPION_BATTLE ; MUSIC_WCS_BATTLE_BW
